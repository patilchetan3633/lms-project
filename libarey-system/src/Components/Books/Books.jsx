...
//               <Form.Select
//                 value={currentBook?.memberId || ""}
//                 onChange={e => setCurrentBook({ ...currentBook, memberId: e.target.value })}
//               >
...
//               <Form.Control
//                 type="date"
//                 value={currentBook?.dueDate || ""}
//                 onChange={e => setCurrentBook({ ...currentBook, dueDate: e.target.value })}
//               />
//             </Form.Group>
//             <Form.Group>
//               <Form.Check
...
//                 onChange={e => setCurrentBook({ ...currentBook, rent: e.target.checked })}
//               />
//             </Form.Group>
...
function Books() {
  ...
  const handleAdd = () => {
    setCurrentBook({ title: "", author: "", genre: "", rent: false, memberId: "", dueDate: "", cover: "" });
    setShowModal(true);
  };
          ...
          <Col key={book.id}>
            <Card className="book-card h-100 shadow-sm">
              ...
              <Card.Body>
                ...
                <Card.Text className="mb-1">✍️ {book.author}</Card.Text>
                <Card.Text className="mb-1">📖 {book.genre}</Card.Text>
                <Card.Text className={book.rent ? "text-danger" : "text-success"}>
                  {book.rent ? "Rented" : "Available"}
                </Card.Text>
                <div className="d-flex gap-2 mt-2">
                  <Button size="sm" variant="warning" onClick={() => handleEdit(book)}>✏️ Edit</Button>
                  <Button size="sm" variant="danger" onClick={() => handleDelete(book.id)}>🗑️ Delete</Button>
